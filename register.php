...
#bg {
  ...
  width: 100%;
  height: 100%;
  background: url(images/hogwarts16.jpg) no-repeat center center fixed;
...
<form action="register.php" method="post">
  ...
  <input type="text" name="name" id="name" placeholder="Name" class="text wid"><br>


  <input type="text" name="username" id="username" placeholder="Username" class="text wid"><br>


  <input type="password" name="password" id="password" placeholder="password" class="pass wid"><br>


  <input type="email" name="email" id="email" placeholder="Email" class="email wid"><br>


  <input type="radio" name="check" id="check"> I am not a MUGGLE<br>
...
$db=mysql_select_db("project1",$connection);
	...
	$query=mysql_query("INSERT INTO userinfo (Name ,Username, Password, Email) VALUES('".$name."','".$username."',
                '".$password."','".$email."');",$connection);
